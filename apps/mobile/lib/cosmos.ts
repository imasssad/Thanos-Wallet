/**
 * Cosmos Hub (ATOM) integration — mobile (React Native).
 * Mirrors apps/web/lib/cosmos.ts. @cosmjs runs fine on RN with the
 * polyfills that the rest of the app already loads (get-random-values,
 * url-polyfill).
 */
...
const RPC_URL  = 'https://cosmos-rpc.publicnode.com';
