/**
 * Client-side encryption for contact `name` + `notes` fields — desktop
 * renderer. Same HKDF-SHA256(seed) → AES-256-GCM primitives as
 * web/extension/mobile so a contact saved on any client decrypts on
 * any other for the same seed.
 */
