/**
 * Sentry — server-side init for the indexer.
 *
 * No-op when SENTRY_DSN is unset. Same scrub patterns as the api +
 * web. Indexer doesn't see signing material in practice, but the
 * recursive redact covers third-party libs that might.
 */
